					...
					<div  class = "container-fluid">
						<div class = "panel panel-default panel-custom">
							...
							<div class = "panel-body">
											...
											<h2><strong>
											<select id = "select_nation" style = "min-width: 200px">
											...
											</select></strong> <a href = "viewNationInfo.php?" > <i class ="fa fa-external-link"> </i></a></h2>
											<p>
											...
											<form action = "warStatus.php">
												<button type = "submit" class = "form-control"  >  Declare War </button>
											</form>
							</div>
