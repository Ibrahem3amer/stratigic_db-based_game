				...
				<main>
					...
					<div  class = "container-fluid">
									...
									<div class = "container-fluid">
										...
										<div class = "row">
											...
											<div class = "col-lg-4  col-md-4 col-sm-6 col-xs-6">
												...
												<p style = "margin-bottom:0px;"> sell price <span class = "green" > $xxx <i class = "fa fa-caret-up"> </i> </span> </p>
												<p style = "margin-bottom:0px;"> buy price <span class = "red" > $xxx <i class = "fa fa-caret-down"> </i> </span> </p>
						...
						<div class = "panel panel-default panel-custom">
							...
							<!-- pending trade deals-->
								<div> 
										<span class = "right panel-div-title">  [1 / 3] </span><br/>
										...
										<div class = "container-fluid">
											...
											<div style = "color: black; background-color: #eeeeee; padding: 15px; border-radius: 5px; border:1px solid lightgrey;">
												...
												<input type = "button" class = "btn btn-default" value = "Make Counter Offer" style = "font-size:22px; padding-left:35px; padding-right:35px;">
												
												<input type = "button" class = "btn btn-default" value = "Reject Offer" style = "font-size:22px; padding-left:35px; padding-right:35px;">
